...
class HotDrinkMachine {
    ...
    public HotDrinkMachine() throws Exception {
        ...
        for (AvailableDrink drink : AvailableDrink.values()) {
            ...
            Class<?> factory = Class.forName("com.manerajona.java.designpatterns.factory." + factoryName + "Factory");
        ...
        Set<Class<? extends IHotDrinkFactory>> types =
                new Reflections("com.manerajona.java.designpatterns.factory").getSubTypesOf(IHotDrinkFactory.class);
